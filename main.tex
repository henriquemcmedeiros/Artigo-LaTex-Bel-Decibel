...
As ondas eletromagnéticas se propagam no vácuo e em alguns meios, surgem em consequência de cargas elétricas oscilantes como é definido por \citeonline{demodelo}.
...
isofônicas}
\centering
\includegraphics{Curvas de igual audibilidade.jpg}
\label{Curvas de igual audibilidade ou
isofônicas}
\end{figure}
